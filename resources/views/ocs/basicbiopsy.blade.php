                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group input-group">
                                                ...
                                                <input type="text" class="form-control input-sm" placeholder="mmHg" required name="minbp" value="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group input-group">
                                                <span class="input-group-addon">최고혈압</span>
                                                <input type="text" class="form-control input-sm" placeholder="mmHg" required name="maxbp" value="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group input-group">
                                                <span class="input-group-addon">맥박</span>
                                                <input type="text" class="form-control input-sm" placeholder="bpm" required name="pb" value="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group input-group">
                                                <span class="input-group-addon">체중</span>
                                                <input type="text" class="form-control input-sm" placeholder="kg" required name="weight" value="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group input-group">
                                                <span class="input-group-addon">체온</span>
                                                <input type="text" class="form-control input-sm" placeholder="℃" required name="temp" value="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group input-group">
                                                <span class="input-group-addon">호흡수</span>
                                                <input type="text" class="form-control input-sm" placeholder="분당" required  name="brate" value="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group input-group">
                                                <span class="input-group-addon">키</span>
                                                <input type="text" class="form-control input-sm" placeholder="Cm" required  name="height" value="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group input-group">
                                                ...
                                                <input type="checkbox" name="diabetes" data-size="small" class="switch" value="1">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
